---
title: "Heat maps"
description: "Our \"heat maps\" support provides a way to overlay scalar volumetric data over the base image for reference purposes. In that sense, you're not strictly limited to only heat maps - perfusion maps, radiotherapy maps, oxygenization maps, and much more can be visualized alongside your images and annotations."
---
...
![](/images/annotation-and-viewer/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-MKt1BePyOQuVTnMGssE%252Fuploads%252FXZFxDKqN9p73CLuCeDKn%252Fimage%2520%2811%29.png)

[PreviousOverlapping Segmentations](/annotation-and-viewer/segmentation/overlapping-segmentations)[NextInstallation & API Keys](/python-sdk/installation-and-api-keys)
