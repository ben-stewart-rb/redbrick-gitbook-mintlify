...
description: "Metadata Schema allows you to configure the workspace according to the metadata schema extracted from a CSV file or the DICOM headers. This schema is highly flexible and not strictly enforced on the uploaded data, providing maximum adaptability to your data format and allowing the schema to evolve."
---
...
[PreviousDatapoint Classification](/projects/get-started-with-workspace/datapoint-classification)[NextTaxonomies](/projects/taxonomies)
