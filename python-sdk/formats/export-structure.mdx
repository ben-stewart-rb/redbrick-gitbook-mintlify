...
description: "RedBrick AI offers several ways to structure exports based on the needs of your annotation workflow."
---
...
<CodeGroup>
  ```standard-export-1 Standard Export
  tasks.json/
  ...
  ```semantic-export-1 Semantic Export
  tasks.json/
    "items": ["image-file.ima",],
    "segmentations": "./path/to/segmentation/file.nii.gz",
    "segmentMap": {
...
[PreviousFull Format Reference](/python-sdk/formats/full-format-reference)
