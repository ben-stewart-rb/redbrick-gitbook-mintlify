...
![](/images/importing-data/import-cloud-data/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-MKt1BePyOQuVTnMGssE%252Fuploads%252FrdXGEUSeky6uLgZApqjw%252FScreen%2520Shot%25202022-11-01%2520at%25208.06.13%2520PM.png)
...
Once you've created your Azure Storage method on RedBrick AI, you have to upload an items list to your projects to import specific datapoints. Please have a look at the [items list documentation](/importing-data/import-cloud-data/creating-an-items-list) for a overview of the format for the JSON file.
...
<Frame caption="Example access configuration">
  <img src="/images/importing-data/import-cloud-data/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-MKt1BePyOQuVTnMGssE%252Fuploads%252Fc6Q1H5w5kdFtJ9Tctm3c%252Fimage.png" />
</Frame>
...
[PreviousConfiguring AWS s3](/importing-data/import-cloud-data/configuring-aws-s3)[NextConfiguring GCS](/importing-data/import-cloud-data/configuring-gcs)
