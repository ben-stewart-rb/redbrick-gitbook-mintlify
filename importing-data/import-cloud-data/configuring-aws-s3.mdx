...
description: "This section covers how to prepare your Amazon S3 storage to import data into the RedBrick AI platform. After following the instructions in this section, you will be able to create an Amazon S3 'storage method' on the RedBrick platform to connect your S3 bucket to your RedBrick account."
---
...
* You can leave all other settings as default. After creating your S3 bucket, **upload your images** through the User Interface, or use the AWS CLI for large amounts of data.
...
<Frame caption="CORS Permissions on s3 bucket console">
  <img src="/images/importing-data/import-cloud-data/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-MKt1BePyOQuVTnMGssE%252Fuploads%252FouvDL1dojDKDKWX8IkW3%252FScreen%2520Shot%25202022-02-23%2520at%25202.43.03%2520PM.png" />
</Frame>
...
<Info>
  **Granular Permissions** You can configure your S3 bucket to give RedBrick AI access to particular data points inside your s3 bucket by modifying the "Resource" section in the file above.
</Info>
...
Once you've created your AWS Storage method on RedBrick AI, you have to upload an items list to your projects to import specific datapoints. Please have a look at the [items list documentation](/importing-data/import-cloud-data/creating-an-items-list) for a overview of the format for the JSON file.
...
[PreviousImport Cloud Data](/importing-data/import-cloud-data)[NextConfiguring Azure Blob](/importing-data/import-cloud-data/configuring-azure-blob)
