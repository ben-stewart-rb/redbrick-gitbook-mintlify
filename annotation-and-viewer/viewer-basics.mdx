---
title: "Viewer Basics"
description: "RedBrick AI is designed for native medical image viewing and annotation, supporting all radiology modalities. The platform supports X-ray, CT, MRI, Ultrasound, and other 2D, 3D, and video modalities."
---

![](/images/annotation-and-viewer/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-MKt1BePyOQuVTnMGssE%252Fuploads%252FLz50mByjNJ6YKgqorhLh%252FRedBrick%2520AI%25202024-01-10%2520at%252012.13.14%25402x.png)
...
RedBrick AI's viewer can be customized to display studies and series in a huge range of configurations, either manually or by using [hanging protocols](/project-settings-and-configuration/custom-hanging-protocol) to display single or multiple series.
...
2. **Displaying series:** You can customize what is shown in each viewport; this can be any 2D or 3D view.
   ...
   * **Drag and drop:** You can drag and drop any series or projection from the layout context panel to a target viewport.
     ...
     <Frame caption="Drag and drop.">
       <img src="/images/annotation-and-viewer/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-MKt1BePyOQuVTnMGssE%252Fuploads%252FzYYdKDVaaJVRw0nwqS28%252FRedBrick%2520AI%25202024-01-10%2520at%252016.02.15.gif" />
     </Frame>
   ...
   * **Viewport selector:** You can use the dropdown on any viewport to cycle between projections of that series.
     ...
     <Frame caption="Viewport selector.">
       <img src="/images/annotation-and-viewer/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-MKt1BePyOQuVTnMGssE%252Fuploads%252FCucKdwJdX6UF540UmEvQ%252FRedBrick%2520AI%25202024-01-10%2520at%252016.03.32.gif" />
     </Frame>
   ...
   * **Quick change:** You can hover over the thumbnails on the layout context panel to directly place the view in the corresponding layout position.
     ...
     <Frame caption="Quick change.">
       <img src="/images/annotation-and-viewer/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-MKt1BePyOQuVTnMGssE%252Fuploads%252F9urbK36Pupr2tzhau86f%252FRedBrick%2520AI%25202024-01-10%2520at%252016.07.27.gif" />
     </Frame>
...
3. **Maximize and minimize view:** When you have more than 2 views displayed, you can maximize 1 viewport so that it's larger than the rest. Pressing `enter` will expand the currently selected viewport. Alternatively, you can `right click` and select `maximize viewport` on the layout menu.
   ...
   ![](/images/annotation-and-viewer/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-MKt1BePyOQuVTnMGssE%252Fuploads%252FGT3BWz840kiNCugd6j9L%252FRedBrick%2520AI%25202024-01-10%2520at%252016.12.09.gif)
...
1. **Manually:** You can create an MPR view by manually configuring the viewport and selecting the projections of your series [following the instructions above](/annotation-and-viewer/viewer-basics#changing-layout-and-displaying-series).

2. **Right-click menu:** You can also display an MPR view by `right click` on the viewport and selecting `MPR layout`. This will [create a new layout tab](/annotation-and-viewer/viewer-basics#creating-multiple-layout-tabs) with the MPR view.
...
[PreviousWebhooks](/project-settings-and-configuration/webhooks)[NextDocument Viewer](/annotation-and-viewer/viewer-basics/document-viewer)
