...
* Configuration settings for the Annotation Tool (`setSegmentationSettings`)\*
  ...
  * **(Note: this function has been replaced by the** [**Tool Settings**](/annotation-and-viewer/segmentation/segmentation-tools#tool-configuration) **page)**
...
Hanging protocols can be used along side [Intellisync](/annotation-and-viewer/viewer-basics/intellisync)for ease of use when annotating scans in a study.
...
<Warning>
  Configuring your Project's toolkit is now done on the [Tool Settings](/annotation-and-viewer/segmentation/segmentation-tools#tool-configuration) page of your Project Settings.
</Warning>

[PreviousCustom Label Validation](/project-settings-and-configuration/custom-label-validation)[NextLabeler Evaluation](/project-settings-and-configuration/labeler-evaluation)
